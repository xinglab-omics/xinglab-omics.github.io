...
export function ResearchIntroPanel({ intro, question, showExploreLink = false }: ResearchIntroPanelProps) {
  return (
    <div className="relative min-h-[330px] overflow-hidden rounded-md bg-paper">
      ...
      />
      <p className="absolute bottom-3 right-3 z-20 text-[10px] font-semibold text-muted">
        Image generated by AI
      </p>
      <div className="relative z-10 flex min-h-[330px] flex-col justify-between gap-8 p-5 sm:p-6 lg:max-w-[58rem]">
        <div>
          <p className="text-sm font-semibold uppercase tracking-normal text-fudan">Research directions</p>
          <p className="mt-4 max-w-[52rem] text-xl font-semibold leading-7 text-ink sm:text-2xl sm:leading-8">
            {question}
          </p>
